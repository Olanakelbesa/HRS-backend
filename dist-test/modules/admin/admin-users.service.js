...
let AdminUsersService = class AdminUsersService {
    ...
    updateUserStatus(adminId, id, status) {
        return adminService.updateUserStatus(adminId, id, status);
    }
    updateUserVerificationState(adminId, id, verificationState, comment) {
        return adminService.updateUserVerificationState(adminId, id, verificationState, comment);
    }
    getPendingVerifications(query) {
        return adminService.getPendingVerifications(query);
    }
    resolveVerification(adminId, id, status, note) {

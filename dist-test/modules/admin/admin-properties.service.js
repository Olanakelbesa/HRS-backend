...
exports.AdminPropertiesService = void 0;
const common_1 = require("@nestjs/common");
const adminService = __importStar(require("./service"));
let AdminPropertiesService = class AdminPropertiesService {
    getProperties(query) {
    ...
    overrideUpdate(adminId, id, body) {
        return adminService.adminOverrideUpdateProperty(adminId, id, body);
    }
    approve(adminId, propertyId, payload) {
        return adminService.approveProperty(adminId, propertyId, payload);
    }
    reject(adminId, propertyId, payload) {
        return adminService.rejectProperty(adminId, propertyId, payload);
    }
};
exports.AdminPropertiesService = AdminPropertiesService;
exports.AdminPropertiesService = AdminPropertiesService = __decorate([

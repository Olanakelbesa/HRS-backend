...
const PERSONAS: Persona[] = [
  {
    ...
    preferredAmenities: ['WiFi', 'Shared kitchen', 'Near public transport', 'Hot shower'],
  ...
  },
  {
    ...
    budget: [12000, 35000],
    bedroomRange: [1, 2],
    preferredTypes: [PropertyType.APARTMENT, PropertyType.STUDIO, PropertyType.SERVICED_APARTMENT],
    preferredLocations: ['Bole Medhanialem', 'Kazanchis', 'CMC', 'Bisrate Gabriel'],
    preferredAmenities: ['WiFi', 'Parking', 'Backup generator', 'Elevator', 'Security'],
  ...
  },
  {
    ...
    preferredAmenities: ['Parking', 'Security', 'Water tank', 'Garden', 'Private compound'],
    furnishStatus: 'semi-furnished',
    sessionsRange: [7, 14],
    viewsPerSession: [4, 8],
    likeRate: 0.28,
  ...
  },
  {
    ...
    budget: [10000, 42000],
    bedroomRange: [1, 3],
    preferredTypes: [PropertyType.APARTMENT, PropertyType.STUDIO, PropertyType.CONDO],
    preferredLocations: ['Bole Medhanialem', 'Megenagna', 'Kazanchis'],
    preferredAmenities: ['Near public transport', 'WiFi', 'Security'],
  ...
  },
  {
    ...
    budget: [8000, 55000],
    bedroomRange: [0, 4],
    preferredTypes: [PropertyType.APARTMENT, PropertyType.STUDIO, PropertyType.VILLA],
    preferredLocations: ['Bole Medhanialem', 'CMC', 'Piassa', 'Adama', 'Hawassa'],
    preferredAmenities: ['WiFi', 'Balcony', 'Parking'],
    furnishStatus: 'semi-furnished',
    sessionsRange: [14, 24],
  ...
  },
  {
    ...
    budget: [18000, 60000],
    bedroomRange: [1, 4],
    preferredTypes: [PropertyType.APARTMENT, PropertyType.VILLA, PropertyType.SERVICED_APARTMENT],
    preferredLocations: ['Bole Medhanialem', 'Kazanchis', 'Ayat', 'CMC'],
    preferredAmenities: ['Security', 'Parking', 'Backup generator', 'Water tank'],
    furnishStatus: 'semi-furnished',
    sessionsRange: [5, 9],
    viewsPerSession: [3, 7],
    likeRate: 0.38,
  ...
  },
  {
    ...
    budget: [12000, 75000],
    bedroomRange: [1, 4],
    preferredTypes: [PropertyType.APARTMENT, PropertyType.VILLA, PropertyType.PENTHOUSE, PropertyType.STUDIO],
    preferredLocations: ['Bole Medhanialem', 'Kazanchis', 'Megenagna', 'Ayat', 'Bahir Dar', 'Hawassa'],
    preferredAmenities: ['WiFi', 'Parking', 'Security', 'Elevator', 'Garden'],
    furnishStatus: 'unfurnished',
    sessionsRange: [12, 22],
  ...
  },
  {
    ...
    budget: [10000, 50000],
    bedroomRange: [1, 3],
    preferredTypes: [PropertyType.STUDIO, PropertyType.APARTMENT, PropertyType.SERVICED_APARTMENT],
    preferredLocations: ['Bisrate Gabriel', 'Bole Medhanialem', 'Kazanchis', 'CMC'],
    preferredAmenities: ['WiFi', 'Backup generator', 'Elevator', 'Parking'],
    furnishStatus: 'furnished',
    sessionsRange: [10, 18],
    viewsPerSession: [4, 9],
    likeRate: 0.2,
